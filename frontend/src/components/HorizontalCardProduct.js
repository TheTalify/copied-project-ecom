    ...
    return (
        <div className='container mx-auto px-4 my-6 relative'>
            ...
            <div className='relative overflow-hidden'>
                <div className='flex items-center gap-4 md:gap-6 transition-all rounded-md' ref={scrollElement}>
                    {loading ? (
                        ...
                        data.map((product, index) => (
                            <Link
                                ...
                                className='w-full min-w-[280px] md:min-w-[420px] max-w-[480px] md:max-w-[420px] h-36 bg-white rounded-lg shadow-md hover:shadow-2xl flex hover:bg-purple-300 transition duration-300'
                            >
                                ...
                                <div className='p-4 grid'>
                                    ...
                                    <button className='text-sm bg-green-300 hover:bg-green-600 text-white px-3 py-0.5 rounded-full w-full' onClick={(e) => handleAddToCart(e, product?._id)}>Add to Cart</button>
                                </div>
                            </Link>
                        ))
                    )}
